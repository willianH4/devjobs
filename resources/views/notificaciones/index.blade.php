    ...
    <ul class="max-w-md mx-auto mt-10">
        @foreach ($notificaciones as $notificacion)
            ...
            <li class="p-5 border border-gray-400 mb-5">
                ...
                <p class="mb-4">
                    Escribio: <span class="font-bold">{{ $notificacion->created_at->diffForHumans() }}</span>
                </p>

                <a href="{{ route('candidatos.index', ['id' => $data['id_vacante']]) }}"
                    class="bg-green-500 p-2 inline-block text-xs font-bold uppercase text-white mt-1 mb-4"
                    >
                    Ver candidatos
                </a>
