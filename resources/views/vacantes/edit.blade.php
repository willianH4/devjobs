...
@section('content')
    ...
    <form class="max-w-lg mx-auto my-10" action="{{ route('vacantes.update', ['vacante' => $vacante->id]) }}" method="post">
        ...
        <div class="mb-5">
            ...
            id="descripcion" value="{{ $vacante->descripcion }}">
        ...
        <div class="mb-5">
            ...
            <input type="hidden" name="imagen" value="{{ $vacante->imagen }}" class="imagen" id="imagen">
        ...
        <button type="submit" class="bg-indigo-500 w-full hover:bg-indigo-600 text-gray-100 font-bold p-3 focus:outline focus:shadow-outline uppercase rounded">Actualizar vacante
        </button>
    </form>
